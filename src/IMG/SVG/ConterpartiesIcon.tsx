...
export const ConterpartiesIcon = (props: any) => {
  const { color } = props;
  return (
    <svg
      width="30"
    ...
    >
      ...
      />
      <path
        d="M7.63855 20.9999C7.86049 20.1413 8.36141 19.3807 9.0626 18.8377C9.76379 18.2947 10.6255 18 11.5124 18C12.3992 18 13.261 18.2946 13.9622 18.8375C14.6634 19.3805 15.1644 20.141 15.3864 20.9997"
        stroke={color}
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
