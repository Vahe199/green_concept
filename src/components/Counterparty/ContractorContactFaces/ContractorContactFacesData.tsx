...
export const ContractorContactFacesData = () => {
    ...
    return (
        <div className={classes.root}>
            <div style={{ width: "50%" }}>
                {changeBasicInformation ? <InformationContactFacesData setChangeBasicInformation={setChangeBasicInformation}/>
               : <FormBasicInformation setChangeBasicInformation={setChangeBasicInformation}/>}
            </div>
            <div style={{ width: "50%" }}>
                <div>
                    {changeContactsFromGreen ?<InformationContactsFromGreen setChangeContactsFromGreen={setChangeContactsFromGreen}/>
