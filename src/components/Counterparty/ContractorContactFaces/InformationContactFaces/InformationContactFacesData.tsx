...
export const InformationContactFacesData:React.FC<InfoProps> = ({setChangeBasicInformation}) => {
        ...
        <div className={classes.root}>
                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.label}>
                     ...
                     <span style={{width:'60%'}}>
                         123456 г. Петропавловск-Камчатский, улица Николая-Прибоя, д. 1 строение 2, подъезд 3, офис 456
                     </span>
                    </div>
