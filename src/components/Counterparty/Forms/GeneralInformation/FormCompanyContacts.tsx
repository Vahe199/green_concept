                ...
                <Paper className={classes.paper}>
                    ...
                    <div className={classes.label}>
                        ...
                        <TextField variant={'outlined'}
                                   ...
                                   onChange={formik.handleChange}
                                   error={formik.touched.ActualAddress && Boolean(formik.errors.ActualAddress)}
                                   helperText={formik.touched.ActualAddress && formik.errors.ActualAddress}
                        />
                    </div>
                    <div >
                                <Checkbox
                    ...
                    <div className={classes.label}>
                        ...
                        <TextField variant={'outlined'}
                                   ...
                                   onChange={formik.handleChange}
                                   error={formik.touched.SiteCompany && Boolean(formik.errors.SiteCompany)}
                                   helperText={formik.touched.SiteCompany && formik.errors.SiteCompany}
                        />
                    </div>
                    <div className={classes.label}>
                        <span>Телефон</span>
