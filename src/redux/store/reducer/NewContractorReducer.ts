import {CategoriesAction, CategoriesActionType, CategoriesState} from "../../types/new_contractor";
...
export const newContractorReducer=(state= initialState, action:CategoriesAction):CategoriesState=>{
    switch (action.type){
