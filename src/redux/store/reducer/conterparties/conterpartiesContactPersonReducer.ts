...
export const counterpartiesContactPersonReducer = (
  ...
  switch (action.type) {
    case ContractorContactDataActionType.INSERT_CONTRACTOR_CONTACT_DATA:
      return {ContactPerson:[],PersonContact:[], NewContactPerson:[],
        error:false,loading:true,success:false};

    case ContractorContactDataActionType.INSERT_CONTRACTOR_CONTACT_DATA_SUCCESS:
      return {...state,NewContactPerson:action.payload,ContactPerson: state.ContactPerson,PersonContact:[],
        error:false,loading:false,success:true};

      case ContractorContactDataActionType.GET_CONTRACTOR_CONTACT_LIST_DATA:
      return {...state,NewContactPerson:state.NewContactPerson,ContactPerson:action.payload,PersonContact:[],
        error:false,loading:false,success:false};

    case ContractorContactDataActionType.GET_CONTRACTOR_CONTACT_DATA_WITH_ID:
      return {...state,NewContactPerson:state.NewContactPerson,ContactPerson:state.ContactPerson,PersonContact:action.payload,
        error:false,loading:false,success:false};
