import {CounterpartiesAction, CounterpartiesActionType, CounterpartiesState} from "../../types/counterparties";
...
export const counterpartiesReducer = (state=initialState, action:CounterpartiesAction):CounterpartiesState=>{
    switch (action.type){
